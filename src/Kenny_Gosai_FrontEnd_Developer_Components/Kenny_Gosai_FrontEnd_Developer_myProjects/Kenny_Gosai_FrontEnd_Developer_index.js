...
const MyProject = () => {
    ...
    <PrimarySearchBar>
        ...
        <Grid container alignItems="flex-start" justify="flex-end" direction="row" style={{'padding-right': '25px', 'padding-top': '25px'}}>
        ...
        <div className={styles.container}>
            ...
            <IconButton aria-label="delete" className={classes.margin} onClick={remove}>
